...
{
  public class RotateLeftCommand : PlayerCommand
  {
    
    private Quaternion degrees;
    private float speed;
    public RotateLeftCommand(Playercontroller playercontroller, float degrees, float speed ):base(playercontroller)
    {
